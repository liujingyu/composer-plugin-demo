...
class TemplateInstaller extends LibraryInstaller
{
    ...
    {
        if ($this->extractPrefix($package) != 'liujingyu/template-') {
            throw new \InvalidArgumentException(
                'Unable to install template, liujingyu templates should '
                .'always start their package name with "liujingyu/template-"'
            );
        }
    ...
    {
      return (bool)('liujingyu-template' === $packageType);
    }
}
